export default function PublicPortalLoading() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[60vh] gap-6 w-full">
      <div className="relative flex items-center justify-center">
        ...
        <div className="relative bg-surface w-14 h-14 rounded-full flex items-center justify-center shadow-level-2 border border-outline-variant/30 z-10 transition-transform hover:scale-105 duration-300">
          <span className="material-symbols-outlined text-primary text-3xl animate-pulse">shopping_bag</span>
        </div>
      </div>
